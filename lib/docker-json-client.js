...
DockerJsonClient.prototype.parse = function parse(err, req, res, callback) {
    return this.parseResponse(req, callback)(err, res);
};

/**
 * Provides method to parse body out of the response object.
 * @private
 * @method parse
 * @param {Object} req the request object
 * @param {Function} callback a callback fn
 * @returns {Object} parsed JSON
 */
DockerJsonClient.prototype.parseResponse = function parseResponse(req, callback) {
        ...
        function finish() {
            ...
            if (!isNaN(contentLength) && len !== contentLength) {
                resErr = new restifyErrors.InvalidContentError(util.format(
                    ...
                    contentLength, len));
                callback(resErr, null, null, req, res);
                return;
            }
            ...
            callback(resErr, obj, body, req, res);
        }
